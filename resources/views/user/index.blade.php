...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">Luissoft-Store</a>
        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-10 align-self-end">
                    <h1 class="text-uppercase text-white font-weight-bold">Manjakan Semua Kebutuhan Fashion Trendy Anda
                        disini</h1>
                    <hr class="divider my-4" />
                </div>
                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white-75 font-weight-light mb-0">Luissoft-Store menyediakan
                        berbagai macam produk pakaian baru maupun bekas</p>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <h2 class="text-white mt-0">Belanja Kebutuhan Pakaian Terlengkap Bagi Anak Muda Masa Kini!</h2>
                    <hr class="divider light my-4" />
                    <p class="text-white-50 mb-4">Luissoft-Store menyediakan berbagai macam produk
                        dan terdapat layanan servis produk Fashion! Hanya dengan daftar dan nikmati berbagai fitur
    ...
    <section class="page-section" id="services">
        <div class="container">
            <h2 class="text-center mt-0">Tentang Luissoft-Store</h2>
            <hr class="divider my-4" />
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        ...
                        <p class="text-muted mb-0">Kami memberikan garansi untuk setiap pemesanan.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                    ...
                    <a class="d-block"
                        href="telp:{{ Custom::getShopData('phone') }}">0334290315</a>
                </div>
                <div class="col-lg-4 mr-auto text-center">
                    <i class="fas fa-envelope fa-3x mb-3 text-muted"></i>
                    <!-- Make sure to change the email address in BOTH the anchor text and the link target below!-->
                    <a class="d-block" href="mailto:luissoft-stores@gmail.com">luissoft-stores@gmail.com</a>
                </div>
            </div>
        </div>
    </section>
