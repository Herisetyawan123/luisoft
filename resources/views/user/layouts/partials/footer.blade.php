    ...
    <div class="row">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="block-5 mb-5">
                ...
                <ul class="list-unstyled">
                    <li class="address">Jl. Gajah Mada, Kepuharjo, Kec. Lumajang, Kabupaten Lumajang, Jawa Timur 67316, Indonesia</li>
                    <li class="phone"><a href="tel://{{ Custom::getShopData('phone') }}">0334290315</a></li>
                </ul>
            </div>
        </div>
    </div>
