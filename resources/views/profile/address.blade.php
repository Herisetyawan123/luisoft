...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        // Set the selected province from the user's data
        $('#province_id').val({{ old('province_id', Auth::user()->province_id) }});
        
        // Fetch and set the cities based on the selected province
        fetchCities();

        // Set the selected city from the user's data after a delay
        setTimeout(function () {
