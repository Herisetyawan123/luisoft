...
Route::middleware(['auth:sanctum', 'verified', 'admin'])->group(function () {
    Route::prefix('dashboard')->group(function () {
        ...
        Route::prefix('reports')->group(function () {
            ...
            Route::get('/stocks', [ReportsController::class, 'stocks'])->name('admin.reports.stock');
            Route::get('/pdf', [ReportsController::class, 'generatePdf'])->name('admin.reports.pdf');
            Route::get('/stocks/pdf', [ReportsController::class, 'generatePdfStock'])->name('admin.reports.pdf-stock');
        });
